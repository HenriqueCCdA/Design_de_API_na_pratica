...
from coffeeApi.level3.framework import Ok, abs_reverse, allow, Created, NoContent, data_required, serialize
...
def receipt(request, id):
    order = coffeeshop.deliver(id=id)
    return NoContent()